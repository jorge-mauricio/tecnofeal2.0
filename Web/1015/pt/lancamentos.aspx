...
<body class="BodyMaster01">
    <div class="Conteiner01">
        <div class="PosLayoutCentral01">
			<!--#Include file="include_cabecalho_interno.aspx"-->
            
                <div style="position: relative; display: block; height: 1px; background-color: #808080; margin-top: 17px; margin-bottom: 17px;">
                </div>
                
            	<!--Fael Produtos-->
                <div align="center" class="DivSombra01" style="position: relative; display: block; height: 115px; background-color: #ffffff;">
                	<div style="position: absolute; display: block; top: 30px; left: 36px;">
                        <img src="img/imgFealGlass.png" alt="Feal Glass" />
                    </div>
                    
                	<div align="right" class="SiteTitulos02" style="position: absolute; display: block; bottom: 26px; right: 30px; color: #808080;">
                        Lan&ccedil;amento
                    </div>
                </div>
            	<!--Fael Produtos-->
            	...
            	<!--Conteúdo-->
                <div align="center" class="DivSombra01" style="position: relative; display: block; height: 1300px; margin-top: 30px; background-color: #ffffff;">
                
                    <!--Linha-->
                    <div style="position: relative; display: block; width: 970px; padding-top: 50px;">
                    	<img src="img/lancamentos02.png" alt="Lancamentos" />
                    </div>
                    <!--Linha-->

    ...
    <div class="Conteiner01">
        <div class="PosLayoutCentral01">
			<!--#Include file="include_cabecalho_interno.aspx"-->
            	...
            	<!--Fael Produtos-->
                <div align="center" class="DivSombra01" style="position: relative; display: block; height: 115px; background-color: #2e4f6a;">
                	<div style="position: absolute; display: block; top: 30px; left: 36px;">
                        <img src="img/imgProdutos.png" alt="Feal Produtos" />
                    </div>
                    
                	<div align="right" class="SiteTitulos02" style="position: absolute; display: block; bottom: 26px; right: 30px;">
            	...
            	<!--Conteúdo-->
                <div style="position: relative; display: block; height: 1752px; margin-top: 30px;">
                    
                <img src="img/produtos03.png" alt="Produtos" border="0" usemap="#Map" />
                <map name="Map" id="Map">
                  <area shape="rect" coords="803,1670,975,1687" href="contato.aspx" />
                </map>
                </div>
            	<!--Categorias Produtos-->
